<?php $__env->startSection('title', 'Сериалы'); ?>
    ...
    <div class="body__main">
        <div class="navigate">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item" href="<?php echo e(route('serialsPage', 1)); ?>">1</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('serialsPage', 2)); ?>">2</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('serialsPage', 3)); ?>">3</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('serialsPage', 4)); ?>">4</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('serialsPage', 5)); ?>">5</a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('serialsPage', 6)); ?>">6</a></li>
                </ul>
            </div>
        </div>
                ...
                <?php if(isset($item->find('img.nbl-poster__image')[0]->src)): ?>
                    <div class="card">
                        <div class="card__all">
                            ...
                            <a class="card__btn" href="<?php echo e(route('serialsView', str_replace('/watch/', '', $item->find('a.nbl-slimPosterBlock')[0]->attr('href')))); ?>">Подробнее</a>
                        </div>
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\laravel\resources\views/serials.blade.php ENDPATH**/ ?>